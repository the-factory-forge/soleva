...
const NOT_FOUND_COPY: Record<Locale, { badge: string; title: string; description: string; backHome: string }> = {
  fr: {
    badge: 'Erreur 404',
...
export function DefaultNotFound() {
  ...
  return (
    <NotFoundPage
      logo={{ src: '/images/soleva-logo.webp', alt: "Accueil", href: `/${locale}` }}
      badge={copy.badge}
      title={copy.title}
